...
@Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2026-08-27T18:33:23.393520600+03:00[Europe/Moscow]", comments = "Generator version: 7.6.0")
@Validated
...
public interface CoursesApi {
    ...
    default CourseResponse createCourse(
    ...
    default CourseResponse getCourseById(
        @Parameter(name = "id", description = "", required = true, in = ParameterIn.PATH) @PathVariable("id") UUID id
    ) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
    ...
    default GetCourses200Response getCourses(
    ...
    default CourseResponse updateCourseById(
        @Parameter(name = "id", description = "", required = true, in = ParameterIn.PATH) @PathVariable("id") UUID id,
